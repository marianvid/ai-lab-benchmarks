...
## What a token buys, by language

The same FLORES sentences, in every language, counted by `gemma-4-26b-a4b`'s tokenizer. Tokens are the unit of everything that
...
cheapest language here after English. The most expensive is lt, written in Latin — the same alphabet as
...
about 60% as much in the most expensive language here as it is in English.
