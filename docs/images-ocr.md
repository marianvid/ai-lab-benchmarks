...
| | Linux workstation | MacBook Pro |
|---|---|---|
| Hardware | RTX PRO 4500 Blackwell, 32 GB GPU memory | Apple M3 Max, 40-core GPU, 128 GB unified memory |
| Image runtime | ComfyUI on NVIDIA CUDA | ComfyUI on Apple MPS |
